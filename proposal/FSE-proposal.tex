...
Le ontologie appena elencate sono dense di contenuto informativo non pienamente
sfruttato, queste infatti dovranno essere maggiormente integrate. Un valido
esempio può essere LOINC i cui codici permetto di identificare univocamente le
diverse tipologie di documenti HL7 e le loro sezioni. 
%
...
PPS è il documento socio-sanitario informatico redatto e aggiornato dal MMG/PLS,
...
concretizzarsi in diverse classi, ognuna identificata da uno specifico codice LOINC:
\begin{itemize}
