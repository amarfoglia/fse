...
\begin{itemize}
    ...
    \item \textbf{Conteggio documenti per organizzazione}
        \begin{verbatim}
    ...
    \item \textbf{Percentuale di entrate in pronto soccorso con ambulanza}
        \begin{verbatim}
    ...
    \item \textbf{Pazienti con vaccini scaduti}
        \begin{verbatim}
    ...
    \item \textbf{Elenco allergie}
     ...
     \item \textbf{Elenco donatori di organi}
        \begin{verbatim}
    ...
    \item \textbf{Descrizione documenti}
        \begin{verbatim}
        SELECT ?id ?desc
        FROM <tag:stardog:api:context:all>
        WHERE {
